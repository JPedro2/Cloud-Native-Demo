...
var Leaflet = function (_TileMap) {
  ...
  function Leaflet(options) {
    ...
    _this.scriptSrc = '/vendor/leaflet-1.4.0/leaflet.js';
    _this.styleSrc = '/vendor/leaflet-1.4.0/leaflet.css';
    _this.ready = false;
  ...
  _createClass(Leaflet, [{
    ...
    value: function onMethod(method,callback) {
      ...
      if (this.ready) {
        this.map.on(method, callback);
        //callback();
      } else {
        setTimeout(function () {
          _this4.onMethod(method,callback);
        }, 200);
      }
    }
  }], [{
