...
_istioctl_experimental_sidecar-bootstrap()
{
    last_command="istioctl_experimental_sidecar-bootstrap"
    ...
    flags+=("--duration=")
    two_word_flags+=("--duration")
    flags+=("--ignore-host-keys")
    flags+=("--istio-image=")
    two_word_flags+=("--istio-image")
    flags+=("--local-dir=")
    two_word_flags+=("--local-dir")
    two_word_flags+=("-d")
    flags+=("--mutual-tls")
    flags+=("--organization=")
    two_word_flags+=("--organization")
    two_word_flags+=("-o")
    flags+=("--remote-directory=")
    two_word_flags+=("--remote-directory")
    flags+=("--remote-scp-path=")
    two_word_flags+=("--remote-scp-path")
    flags+=("--spiffe-trust-domain=")
    two_word_flags+=("--spiffe-trust-domain")
    flags+=("--ssh-key=")
